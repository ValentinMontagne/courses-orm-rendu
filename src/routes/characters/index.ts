...
import { createCharacter, deleteCharacterById, getAllCharacters, getCharacterById, updateCharacterById } from "../../lib/character/character.service";
...
router.post("/", async (req: Request, res: Response) => {
  ...
  router.put("/:id", async (req: Request, res: Response) => {
    try {
      ...
      await updateCharacterById(characterId, updatedCharacterData);
